...
START_GIL = 80000; -- Amount of gil given to newly created characters.
...
-- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME = 12;       -- Hours before player can renter Dynamis. Default is 1 Earthday (24 hours).
